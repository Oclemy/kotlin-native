...
DecreasingPowers<31, 32> p32;   // [base^32, base^31, .., base^2, base, 1]
...
inline void polyHashNeonUnalignedTail(int n, uint16_t const* str, uint32x4_t& res) {
  ...
  uint32x4_t z4_7 = vmulq_u32(x4_7, *reinterpret_cast<uint32x4_t*>(p32.values + 28)); // [b^3, b^2, b, 1]

  res = vmulq_u32(res, *reinterpret_cast<uint32x4_t*>(b4.values));
...
inline void polyHashNeonUnalignedUnroll32(int& n, uint16_t const*& str, uint32x4_t& res) {
  ...
  res = vmulq_u32(res, *reinterpret_cast<uint32x4_t*>(b32.values));
  ...
  do {
    ...
    res0 = vmulq_u32(res0, *reinterpret_cast<uint32x4_t*>(b32.values));
    res1 = vmulq_u32(res1, *reinterpret_cast<uint32x4_t*>(b32.values));
    res2 = vmulq_u32(res2, *reinterpret_cast<uint32x4_t*>(b32.values));
    res3 = vmulq_u32(res3, *reinterpret_cast<uint32x4_t*>(b32.values));
    res4 = vmulq_u32(res4, *reinterpret_cast<uint32x4_t*>(b32.values));
    res5 = vmulq_u32(res5, *reinterpret_cast<uint32x4_t*>(b32.values));
    res6 = vmulq_u32(res6, *reinterpret_cast<uint32x4_t*>(b32.values));
    res7 = vmulq_u32(res7, *reinterpret_cast<uint32x4_t*>(b32.values));
    uint32x4_t z0_3   = vmulq_u32(x0_3,   *reinterpret_cast<uint32x4_t*>(p32.values));      // [b^31, b^30, b^29, b^28]
    uint32x4_t z4_7   = vmulq_u32(x4_7,   *reinterpret_cast<uint32x4_t*>(p32.values + 4));  // [b^27, b^26, b^25, b^24]
    uint32x4_t z8_11  = vmulq_u32(x8_11,  *reinterpret_cast<uint32x4_t*>(p32.values + 8));  // [b^23, b^22, b^21, b^20]
    uint32x4_t z12_15 = vmulq_u32(x12_15, *reinterpret_cast<uint32x4_t*>(p32.values + 12)); // [b^19, b^18, b^17, b^16]
    uint32x4_t z16_19 = vmulq_u32(x16_19, *reinterpret_cast<uint32x4_t*>(p32.values + 16)); // [b^15, b^14, b^13, b^12]
    uint32x4_t z20_23 = vmulq_u32(x20_23, *reinterpret_cast<uint32x4_t*>(p32.values + 20)); // [b^11, b^10, b^9,  b^8 ]
    uint32x4_t z24_27 = vmulq_u32(x24_27, *reinterpret_cast<uint32x4_t*>(p32.values + 24)); // [b^7,  b^6,  b^5,  b^4 ]
    uint32x4_t z28_31 = vmulq_u32(x28_31, *reinterpret_cast<uint32x4_t*>(p32.values + 28)); // [b^3,  b^2,  b,    1   ]
...
inline void polyHashNeonUnalignedUnroll16(int& n, uint16_t const*& str, uint32x4_t& res) {
  ...
  res = vmulq_u32(res, *reinterpret_cast<uint32x4_t*>(b16.values));
  ...
  do {
    ...
    uint32x4_t x8_11  = vmovl_u16(*reinterpret_cast<uint16x4_t const*>(str + 8));
    uint32x4_t x12_15 = vmovl_u16(*reinterpret_cast<uint16x4_t const*>(str + 12));
    res0 = vmulq_u32(res0, *reinterpret_cast<uint32x4_t*>(b16.values));
    res1 = vmulq_u32(res1, *reinterpret_cast<uint32x4_t*>(b16.values));
    res2 = vmulq_u32(res2, *reinterpret_cast<uint32x4_t*>(b16.values));
    res3 = vmulq_u32(res3, *reinterpret_cast<uint32x4_t*>(b16.values));
    uint32x4_t z0_3   = vmulq_u32(x0_3,   *reinterpret_cast<uint32x4_t*>(p32.values + 16)); // [b^15, b^14, b^13, b^12]
    uint32x4_t z4_7   = vmulq_u32(x4_7,   *reinterpret_cast<uint32x4_t*>(p32.values + 20)); // [b^11, b^10, b^9,  b^8 ]
    uint32x4_t z8_11  = vmulq_u32(x8_11,  *reinterpret_cast<uint32x4_t*>(p32.values + 24)); // [b^7,  b^6,  b^5,  b^4 ]
    uint32x4_t z12_15 = vmulq_u32(x12_15, *reinterpret_cast<uint32x4_t*>(p32.values + 28)); // [b^3,  b^2,  b,    1   ]
    res0 = vaddq_u32(res0, z0_3);
    res1 = vaddq_u32(res1, z4_7);
    res2 = vaddq_u32(res2, z8_11);
    res3 = vaddq_u32(res3, z12_15);
...
inline void polyHashNeonUnalignedUnroll8(int& n, uint16_t const*& str, uint32x4_t& res) {
  ...
  res = vmulq_u32(res, *reinterpret_cast<uint32x4_t*>(b8.values));
  ...
  do {
    uint32x4_t x0_3 = vmovl_u16(*reinterpret_cast<uint16x4_t const*>(str));
    uint32x4_t x4_7 = vmovl_u16(*reinterpret_cast<uint16x4_t const*>(str + 4));
    res0 = vmulq_u32(res0, *reinterpret_cast<uint32x4_t*>(b8.values));
    res1 = vmulq_u32(res1, *reinterpret_cast<uint32x4_t*>(b8.values));
    uint32x4_t z0_3 = vmulq_u32(x0_3, *reinterpret_cast<uint32x4_t*>(p32.values + 24)); // [b^7, b^6, b^5, b^4]
    uint32x4_t z4_7 = vmulq_u32(x4_7, *reinterpret_cast<uint32x4_t*>(p32.values + 28)); // [b^3, b^2, b,   1  ]
    res0 = vaddq_u32(res0, z0_3);
    res1 = vaddq_u32(res1, z4_7);
...
int polyHashNeonUnalignedUnrollUpTo8(int n, uint16_t const* str) {
