...
inline void polyHashAVX2UnalignedUnroll64(int& n, uint16_t const*& str, __m128i& res) {
    ...
    do {
        ...
        res0 = _mm256_mullo_epi32(res0, *reinterpret_cast<__m256i const*>(&b64[0]));
        res1 = _mm256_mullo_epi32(res1, *reinterpret_cast<__m256i const*>(&b64[0]));
        res2 = _mm256_mullo_epi32(res2, *reinterpret_cast<__m256i const*>(&b64[0]));
        res3 = _mm256_mullo_epi32(res3, *reinterpret_cast<__m256i const*>(&b64[0]));
        res4 = _mm256_mullo_epi32(res4, *reinterpret_cast<__m256i const*>(&b64[0]));
        res5 = _mm256_mullo_epi32(res5, *reinterpret_cast<__m256i const*>(&b64[0]));
        res6 = _mm256_mullo_epi32(res6, *reinterpret_cast<__m256i const*>(&b64[0]));
        res7 = _mm256_mullo_epi32(res7, *reinterpret_cast<__m256i const*>(&b64[0]));
        __m256i z0_7   = _mm256_mullo_epi32(x0_7,   *reinterpret_cast<__m256i const*>(&p64[0]));  // [b^63, .., b^56]
        __m256i z8_15  = _mm256_mullo_epi32(x8_15,  *reinterpret_cast<__m256i const*>(&p64[8]));  // [b^55, .., b^48]
        __m256i z16_23 = _mm256_mullo_epi32(x16_23, *reinterpret_cast<__m256i const*>(&p64[16])); // [b^47, .., b^40]
        __m256i z24_31 = _mm256_mullo_epi32(x24_31, *reinterpret_cast<__m256i const*>(&p64[24])); // [b^39, .., b^32]
        __m256i z32_39 = _mm256_mullo_epi32(x32_39, *reinterpret_cast<__m256i const*>(&p64[32])); // [b^31, .., b^24]
        __m256i z40_47 = _mm256_mullo_epi32(x40_47, *reinterpret_cast<__m256i const*>(&p64[40])); // [b^23, .., b^16]
        __m256i z48_55 = _mm256_mullo_epi32(x48_55, *reinterpret_cast<__m256i const*>(&p64[48])); // [b^15, .., b^8 ]
        __m256i z56_63 = _mm256_mullo_epi32(x56_63, *reinterpret_cast<__m256i const*>(&p64[56])); // [b^7,  .., b, 1]
...
inline void polyHashAVX2UnalignedUnroll32(int& n, uint16_t const*& str, __m128i& res) {
    ...
    res = _mm_mullo_epi32(res, *reinterpret_cast<__m128i const*>(&b32[0]));
    ...
    do {
        ...
        __m256i x16_23 = _mm256_cvtepu16_epi32(*reinterpret_cast<__m128i const*>(str + 16));
        __m256i x24_31 = _mm256_cvtepu16_epi32(*reinterpret_cast<__m128i const*>(str + 24));
        res0 = _mm256_mullo_epi32(res0, *reinterpret_cast<__m256i const*>(&b32[0]));
        res1 = _mm256_mullo_epi32(res1, *reinterpret_cast<__m256i const*>(&b32[0]));
        res2 = _mm256_mullo_epi32(res2, *reinterpret_cast<__m256i const*>(&b32[0]));
        res3 = _mm256_mullo_epi32(res3, *reinterpret_cast<__m256i const*>(&b32[0]));
        __m256i z0_7   = _mm256_mullo_epi32(x0_7,   *reinterpret_cast<__m256i const*>(&p64[32])); // [b^31, .., b^24]
        __m256i z8_15  = _mm256_mullo_epi32(x8_15,  *reinterpret_cast<__m256i const*>(&p64[40])); // [b^23, .., b^16]
        __m256i z16_23 = _mm256_mullo_epi32(x16_23, *reinterpret_cast<__m256i const*>(&p64[48])); // [b^15, .., b^8 ]
        __m256i z24_31 = _mm256_mullo_epi32(x24_31, *reinterpret_cast<__m256i const*>(&p64[56])); // [b^7,  .., b, 1]
        res0 = _mm256_add_epi32(res0, z0_7);
        res1 = _mm256_add_epi32(res1, z8_15);
        res2 = _mm256_add_epi32(res2, z16_23);
        res3 = _mm256_add_epi32(res3, z24_31);
...
inline void polyHashAVX2UnalignedUnroll16(int& n, uint16_t const*& str, __m128i& res) {
    ...
    res = _mm_mullo_epi32(res, *reinterpret_cast<__m128i const*>(&b16[0]));
    ...
    do {
        __m256i x0_7  = _mm256_cvtepu16_epi32(*reinterpret_cast<__m128i const*>(str));
        __m256i x8_15 = _mm256_cvtepu16_epi32(*reinterpret_cast<__m128i const*>(str + 8));
        res0 = _mm256_mullo_epi32(res0, *reinterpret_cast<__m256i const*>(&b16[0]));
        res1 = _mm256_mullo_epi32(res1, *reinterpret_cast<__m256i const*>(&b16[0]));
        __m256i z0_7  = _mm256_mullo_epi32(x0_7,  *reinterpret_cast<__m256i const*>(&p64[48])); // [b^15, .., b^8]
        __m256i z8_15 = _mm256_mullo_epi32(x8_15, *reinterpret_cast<__m256i const*>(&p64[56])); // [b^7, .., b, 1]
        res0 = _mm256_add_epi32(res0, z0_7);
        res1 = _mm256_add_epi32(res1, z8_15);
...
inline void polyHashSSEUnalignedUnroll16(int& n, uint16_t const*& str, __m128i& res) {
    ...
    do {
        ...
        res0 = _mm_mullo_epi32(res0, *reinterpret_cast<__m128i const*>(&b16[0]));
        res1 = _mm_mullo_epi32(res1, *reinterpret_cast<__m128i const*>(&b16[0]));
        res2 = _mm_mullo_epi32(res2, *reinterpret_cast<__m128i const*>(&b16[0]));
        res3 = _mm_mullo_epi32(res3, *reinterpret_cast<__m128i const*>(&b16[0]));
        __m128i z0_7   = _mm_mullo_epi32(x0_7,   *reinterpret_cast<__m128i const*>(&p64[48])); // [b^15, b^14, b^13, b^12]
        __m128i z8_15  = _mm_mullo_epi32(x8_15,  *reinterpret_cast<__m128i const*>(&p64[52])); // [b^11, b^10, b^9,  b^8 ]
        __m128i z16_23 = _mm_mullo_epi32(x16_23, *reinterpret_cast<__m128i const*>(&p64[56])); // [b^7,  b^6,  b^5,  b^4 ]
        __m128i z24_31 = _mm_mullo_epi32(x24_31, *reinterpret_cast<__m128i const*>(&p64[60])); // [b^3,  b^2,  b,    1   ]
...
inline void polyHashSSEUnalignedUnroll8(int& n, uint16_t const*& str, __m128i& res) {
    ...
    do {
        __m128i x0_7  = _mm_cvtepu16_epi32(*reinterpret_cast<__m128i const*>(str));
        __m128i x8_15 = _mm_cvtepu16_epi32(*reinterpret_cast<__m128i const*>(str + 4));
        res0 = _mm_mullo_epi32(res0, *reinterpret_cast<__m128i const*>(&b8[0]));
        res1 = _mm_mullo_epi32(res1, *reinterpret_cast<__m128i const*>(&b8[0]));
        __m128i z0_7  = _mm_mullo_epi32(x0_7,  *reinterpret_cast<__m128i const*>(&p64[56])); // [b^7, b^6, b^5, b^4]
        __m128i z8_15 = _mm_mullo_epi32(x8_15, *reinterpret_cast<__m128i const*>(&p64[60])); // [b^3, b^2, b,   1  ]
        res0 = _mm_add_epi32(res0, z0_7);
        res1 = _mm_add_epi32(res1, z8_15);
